        ...
        return [
            merge(
                ...
                (
                    ...
                    match_target_name = missing,
                    match_module = missing,
                    match_module_kind = missing,
                    match_path = missing,
                    match_dependency_kind = missing,
                    match_dependency_form = missing,
                    match_dependency_target = missing,
                    match_dependency_is_relative = missing,
                    match_dependency_relative_level = missing,
                    match_dependency_local_name = missing,
                    ...
                    match_root_module_name = missing,
                    match_module_name = missing,
                    match_module_path = missing,
                    match_class_path = missing,
                    match_target_path = missing,
                    match_top_level = missing,
                    match_reexported = missing,
                    match_visibility = missing,
                    match_type_name = missing,
                    match_binding_kind = missing,
                    match_type_kind = missing,
                    match_type_parameters = missing,
                    match_type_supertype = missing,
                    match_primitive_bits = missing,
                    match_variability = missing,
                    match_direction = missing,
                    match_component_kind = missing,
                    match_default_value = missing,
                    match_unit = missing,
                    match_is_partial = missing,
                    match_is_final = missing,
                    match_is_encapsulated = missing,
        ...
        push!(
            ...
            merge(
                ...
                (
                    ...
                    match_target_name = _parser_match_value(match, "target_name"),
                    ...
                    match_dependency_form = _parser_match_value(match, "dependency_form"),
                    match_dependency_target = _parser_match_value(
                        match,
                        "dependency_target",
                    ),
                    match_dependency_is_relative = _parser_match_bool(
                        match,
                        "dependency_is_relative",
                    ),
                    match_dependency_relative_level = _parser_match_int(
                        match,
                        "dependency_relative_level",
                    ),
                    match_dependency_local_name = _parser_match_value(
                        match,
                    ...
                    match_root_module_name = _parser_match_value(match, "root_module_name"),
                    ...
                    match_top_level = _parser_match_bool(match, "top_level"),
                    match_reexported = _parser_match_bool(match, "reexported"),
                    match_visibility = _parser_match_value(match, "visibility"),
                    match_type_name = _parser_match_value(match, "type_name"),
                    match_binding_kind = _parser_match_value(match, "binding_kind"),
                    match_type_kind = _parser_match_value(match, "type_kind"),
                    match_type_parameters = _parser_match_value(match, "type_parameters"),
                    match_type_supertype = _parser_match_value(match, "type_supertype"),
                    match_primitive_bits = _parser_match_value(match, "primitive_bits"),
                    match_variability = _parser_match_value(match, "variability"),
                    match_direction = _parser_match_value(match, "direction"),
                    match_component_kind = _parser_match_value(match, "component_kind"),
                    match_default_value = _parser_match_value(match, "default_value"),
                    match_unit = _parser_match_value(match, "unit"),
                    match_is_partial = _parser_match_bool(match, "is_partial"),
                    match_is_final = _parser_match_bool(match, "is_final"),
                    match_is_encapsulated = _parser_match_bool(match, "is_encapsulated"),
                    ...
                    match_owner_signature = _parser_match_value(match, "owner_signature"),
